...
export default class View {
  ...
  createContentContainer() {
	 ...
	 container.setAttribute("class", "mleh");
  ...
  moveUp() {
    if (this.window.current == this.window.top) {
      if (this.window.current == 0) {
        ...
        this.window.top = this.window.current - this.windowLength < 0 ? 0 : this.window.current - this.windowLength;
      } else {
