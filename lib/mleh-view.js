...
export default class MlehView {
  ...
  goto() {
    let selectedElement = document.getElementById('mleh-selectedItem');
  ...
  e = document.getElementById("mleh-selectedItem");
...
export class MatchingList extends Component {
  ...
  render() {
    ...
    let listItems = keys.map((key, i) => {
      ...
      if (i == selectedI) {
        return ( <ListItem class="list-item mleh-selected" value={key.displayName} id="mleh-selectedItem" />);
      } else {
        return ( <ListItem class="list-item" value={key.displayName} />);
      }
    });
    return (
  ...
  render() {
    return (
      <div className={this.props.class} id={this.props.id}>
        { this.props.label ? <ListItemLabel path={this.props.value} />
        : "" }
        {this.props.value}
      </div>
    )
